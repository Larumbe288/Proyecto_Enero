                                ...
                                <div id="multi-filter-select_wrapper"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="dataTables_length" id="multi-filter-select_length"><label>Show
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div id="multi-filter-select_filter" class="dataTables_filter"><label>Search:<input
                                                            ...
                                                            placeholder="" aria-controls="multi-filter-select"></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <table id="multi-filter-select"
                                                ...
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0"
                                                        ...
                                                        style="width: 242.328px;">Name
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="multi-filter-select"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Position: activate to sort column ascending"
                                                        style="width: 366.703px;">Position
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="multi-filter-select"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Office: activate to sort column ascending"
                                                        style="width: 193.406px;">Office
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="multi-filter-select"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Age: activate to sort column ascending"
                                                        style="width: 83.4219px;">Age
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="multi-filter-select"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Start date: activate to sort column ascending"
                                                        style="width: 159.547px;">Start date
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="multi-filter-select"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Salary: activate to sort column ascending"
                                                        style="width: 159.594px;">Salary
                                                    </th>
                                                </tr>
                                                </thead>
                                                <tfoot>
                                                <tr>
                                                    <th rowspan="1" colspan="1"><select class="form-control">
                                                            <option value=""></option>
                                                            ...
                                                            <option value="Brielle Williamson">Brielle Williamson
                                                            </option>
                                                            ...
                                                            <option value="Tatyana Fitzpatrick">Tatyana Fitzpatrick
                                                            </option>
                                                    ...
                                                    <th rowspan="1" colspan="1"><select class="form-control">
                                                            ...
                                                            <option value="Chief Marketing Officer (CMO)">Chief
                                                                Marketing Officer (CMO)
                                                            </option>
                                                            <option value="Chief Operating Officer (COO)">Chief
                                                            ...
                                                            <option value="Financial Controller">Financial Controller
                                                            </option>
                                                            <option value="Integration Specialist">Integration
                                                                Specialist
                                                            </option>
                                                            <option value="Javascript Developer">Javascript Developer
                                                            </option>
                                                            <option value="Junior Javascript Developer">Junior
                                                                Javascript Developer
                                                            </option>
                                                            <option value="Junior Technical Author">Junior Technical
                                                                Author
                                                            </option>
                                                            <option value="Marketing Designer">Marketing Designer
                                                            </option>
                                                            <option value="Office Manager">Office Manager</option>
                                                            <option value="Personnel Lead">Personnel Lead</option>
                                                            <option value="Post-Sales support">Post-Sales support
                                                            </option>
                                                            <option value="Pre-Sales Support">Pre-Sales Support</option>
                                                            <option value="Regional Director">Regional Director</option>
                                                            <option value="Regional Marketing">Regional Marketing
                                                            </option>
                                                            <option value="Sales Assistant">Sales Assistant</option>
                                                            <option value="Secretary">Secretary</option>
                                                            <option value="Senior Javascript Developer">Senior
                                                                Javascript Developer
                                                            </option>
                                                            <option value="Senior Marketing Designer">Senior Marketing
                                                                Designer
                                                            </option>
                                                            ...
                                                            <option value="Systems Administrator">Systems
                                                                Administrator
                                                            </option>
